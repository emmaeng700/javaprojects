...
public class FileUploadIntegrationTests {
    ...
    void listFiles_withNoFiles_shouldReturnEmptyList() {
        ResponseEntity<List> response = restTemplate.getForEntity(baseUrl + "/files", List.class);
    ...
    void getCount_withNoFiles_shouldReturnZero() {
        ResponseEntity<Map> response = restTemplate.getForEntity(baseUrl + "/count", Map.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
